...
// ── Styles (copied from Hero, adapted for Skills) ─────────────────────────
...
const Skills = () => {
  // Hero‑style coin burst on mouse move (replaces the old AnimatePresence effect)
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: `url('https://images.unsplash.com/photo-1631384916671-3d4be55a8c92?q=80&w=1212&auto=format&fit=crop')`,

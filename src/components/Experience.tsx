...
// ── Styles (copied from Hero, adapted for Experience page) ───────────────
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: `url('https://images.unsplash.com/photo-1621264448270-9ef00e88a935?q=80&w=657&auto=format&fit=crop')`,
        ...
        {/* Coin burst on hover (Hero style) */}
        {coins.map((coin) => (
          <div
            key={coin.id}
        ...
        {/* Content (original, with framer-motion hover effects preserved) */}
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            ...
            {/* Optional CTA button can be uncommented if needed */}
          </motion.div>
        </div>
      </section>
    </>
